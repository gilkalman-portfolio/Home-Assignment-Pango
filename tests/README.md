...
|---|---|---|
| ✅ Pass | 12 | Currently working correctly |
| ⚠️ xfail | 5 | Known bugs — will auto-pass once bugs are fixed |
...
| Letters in plate → blocked, "must be exactly 8 digits" shown (not a bug) | ✅ passes |
